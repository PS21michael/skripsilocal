...
class InquiryRepublikaNewsInternasional extends StatefulWidget {
  const InquiryRepublikaNewsInternasional({Key? key}) : super(key: key);

  @override
  State<InquiryRepublikaNewsInternasional> createState() => _InquiryRepublikaNewsInternasionalState();
}

class _InquiryRepublikaNewsInternasionalState extends State<InquiryRepublikaNewsInternasional> {
  ...
  Future<BeritaModel?> getData() async {
    try {
      String url = 'https://api-berita-indonesia.vercel.app/republika/internasional';
  ...
  void processData(BeritaModel data) async {
    ...
    await RepublikaNewsRepository.instance.getAllNewsRepublikaInternasional(tempCtr-2);
    await RepublikaNewsRepository.instance.getAllNewsRepublikaInternasional(tempCtr-3);
    List<String> listJudul = RepublikaNewsRepository.instance.getListJudulNewsRepublikaInternasional();
