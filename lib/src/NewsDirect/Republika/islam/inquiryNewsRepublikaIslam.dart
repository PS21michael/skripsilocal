...
class InquiryRepublikaNewsIslam extends StatefulWidget {
  ...
  @override
  State<InquiryRepublikaNewsIslam> createState() => _InquiryRepublikaNewsIslamState();
}

class _InquiryRepublikaNewsIslamState extends State<InquiryRepublikaNewsIslam> {
