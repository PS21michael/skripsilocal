...
class InquirySuaraNewsTekno extends StatefulWidget {
  ...
  @override
  State<InquirySuaraNewsTekno> createState() => _InquirySuaraNewsTeknoState();
}

class _InquirySuaraNewsTeknoState extends State<InquirySuaraNewsTekno> {
  ...
  void processData(BeritaModel data) async {
    ...
    SuaraNewsRepository.instance.setNullListJudulTeknoSuaraNews();
    await Future.delayed(const Duration(milliseconds: 100));
