...
class InquirySuaraNewsLifeStyle extends StatefulWidget {
  ...
  @override
  State<InquirySuaraNewsLifeStyle> createState() => _InquirySuaraNewsLifeStyleState();
}

class _InquirySuaraNewsLifeStyleState extends State<InquirySuaraNewsLifeStyle> {
  ...
  void processData(BeritaModel data) async {
    ...
    SuaraNewsRepository.instance.setNullListJudulLifeStyleSuaraNews();
    await Future.delayed(const Duration(milliseconds: 100));
