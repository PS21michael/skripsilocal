...
class InquirySuaraNewsHealth extends StatefulWidget {
  ...
  @override
  State<InquirySuaraNewsHealth> createState() => _InquirySuaraHealth();
}

class _InquirySuaraHealth extends State<InquirySuaraNewsHealth> {
  ...
  _getData() async {
    try {
      ...
      SuaraNewsRepository.instance.setNullListJudulHealthSuaraNews();
      await Future.delayed(Duration(milliseconds: 100));
      ...
      await SuaraNewsRepository.instance.getAllNewsSuaraHealth(tempCtr-2);
      await SuaraNewsRepository.instance.getAllNewsSuaraHealth(tempCtr-3);
      List<String> listJudul = SuaraNewsRepository.instance.getListJudulHealthSuaraNews();
