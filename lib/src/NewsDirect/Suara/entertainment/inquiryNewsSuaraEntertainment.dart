...
class InquirySuaraNewsEntertainment extends StatefulWidget {
  ...
  @override
  State<InquirySuaraNewsEntertainment> createState() => _InquirySuaraNewsEntertainmentState();
}

class _InquirySuaraNewsEntertainmentState extends State<InquirySuaraNewsEntertainment> {
  ...
  void processData(BeritaModel data) async {
    ...
    SuaraNewsRepository.instance.setNullListJudulEntertainmentSuaraNews();
    await Future.delayed(const Duration(milliseconds: 100));
