...
class InquiryAntaraNewsOtomotif extends StatefulWidget {
  ...
  @override
  State<InquiryAntaraNewsOtomotif> createState() => _InquiryAntaraNewsOtomotifState();
}

class _InquiryAntaraNewsOtomotifState extends State<InquiryAntaraNewsOtomotif> {
...
void processData(BeritaModel data) async {
    ...
    AntaraNewsRepository.instance.setNullListJudulOtomotifAntaraNews();
    await Future.delayed(const Duration(milliseconds: 100));
