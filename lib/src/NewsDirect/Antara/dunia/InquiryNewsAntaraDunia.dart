...
class InquiryAntaraNewsInternasional extends StatefulWidget {
  ...
  @override
  State<InquiryAntaraNewsInternasional> createState() => _InquiryAntaraNewsInternasionalState();
}

class _InquiryAntaraNewsInternasionalState extends State<InquiryAntaraNewsInternasional> {
  ...
  void processData(BeritaModel data) async {
    ...
    AntaraNewsRepository.instance.getListJudulInternasionalAntaraNews();
    await Future.delayed(const Duration(milliseconds: 100));
