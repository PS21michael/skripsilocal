...
class InquiryAntaraNewsOlahraga extends StatefulWidget {
  ...
  @override
  State<InquiryAntaraNewsOlahraga> createState() => _InquiryAntaraNewsOlahragaState();
}

class _InquiryAntaraNewsOlahragaState extends State<InquiryAntaraNewsOlahraga> {
