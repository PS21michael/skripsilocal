...
class InquiryAntaraNewsHiburan extends StatefulWidget {
  ...
  @override
  State<InquiryAntaraNewsHiburan> createState() => _InquiryAntaraNewsHiburanState();
}

class _InquiryAntaraNewsHiburanState extends State<InquiryAntaraNewsHiburan> {
  ...
  void processData(BeritaModel data) async {
    ...
    AntaraNewsRepository.instance.setNullListJudulHiburanAntaraNews();
    await Future.delayed(const Duration(milliseconds: 100));
