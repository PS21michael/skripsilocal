...
class InquiryAntaraNewsLifeStyle extends StatefulWidget {
  ...
  @override
  State<InquiryAntaraNewsLifeStyle> createState() => _InquiryAntaraNewsLifeStyleState();
}

class _InquiryAntaraNewsLifeStyleState extends State<InquiryAntaraNewsLifeStyle> {
  ...
  void processData(BeritaModel data) async {
    ...
    AntaraNewsRepository.instance.setNullListJudulLifeStyleAntaraNews();
    await Future.delayed(const Duration(milliseconds: 100));
