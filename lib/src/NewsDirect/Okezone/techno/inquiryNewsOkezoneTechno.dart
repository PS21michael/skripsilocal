...
class InquiryOkezoneNewsTechno extends StatefulWidget {
  const InquiryOkezoneNewsTechno({Key? key}) : super(key: key);

  @override
  State<InquiryOkezoneNewsTechno> createState() => _InquiryOkezoneNewsTechnoState();
}

class _InquiryOkezoneNewsTechnoState extends State<InquiryOkezoneNewsTechno> {
  final newsRepo = Get.put(OkezoneNewsRepository());
  final String author = "Sindikasi techno.okezone.com";
