...
class InquiryOkezoneNewsSports extends StatefulWidget {
  const InquiryOkezoneNewsSports({Key? key}) : super(key: key);

  @override
  State<InquiryOkezoneNewsSports> createState() => _InquiryOkezoneNewsSportsState();
}

class _InquiryOkezoneNewsSportsState extends State<InquiryOkezoneNewsSports> {
  ...
  Future<BeritaModel?> getData() async {
    try {
      String url = 'https://api-berita-indonesia.vercel.app/okezone/sports';
  ...
  void processData(BeritaModel data) async {
    ...
    OkezoneNewsRepository.instance.setNullListJudulSportsOkezoneNews();
    await Future.delayed(const Duration(milliseconds: 100));
    int tempCtr = OkezoneNewsRepository.instance.getCountPeriod();
    await OkezoneNewsRepository.instance.getAllNewsOkezoneSports(tempCtr);
    await OkezoneNewsRepository.instance.getAllNewsOkezoneSports(tempCtr-1);
    await OkezoneNewsRepository.instance.getAllNewsOkezoneSports(tempCtr-2);
    await OkezoneNewsRepository.instance.getAllNewsOkezoneSports(tempCtr-3);
    List<String> listJudul = OkezoneNewsRepository.instance.getListJudulSportsOkezoneNews();
