...
class InquiryOkezoneNewsEconomy extends StatefulWidget {
  ...
  @override
  State<InquiryOkezoneNewsEconomy> createState() => _InquiryOkezoneNewsEconomyState();
}

class _InquiryOkezoneNewsEconomyState extends State<InquiryOkezoneNewsEconomy> {
  ...
  void processData(BeritaModel data) async {
    ...
    OkezoneNewsRepository.instance.setNullListJudulEconomyOkezoneNews();
    await Future.delayed(const Duration(milliseconds: 100));
