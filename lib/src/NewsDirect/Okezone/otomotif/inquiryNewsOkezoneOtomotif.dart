...
class InquiryOkezoneNewsOtomotif extends StatefulWidget {
  ...
  @override
  State<InquiryOkezoneNewsOtomotif> createState() => _InquiryOkezoneNewsOtomotifState();
}

class _InquiryOkezoneNewsOtomotifState extends State<InquiryOkezoneNewsOtomotif> {
  ...
  void processData(BeritaModel data) async {
    ...
    OkezoneNewsRepository.instance.setNullListJudulOtomotifOkezoneNews();
    await Future.delayed(const Duration(milliseconds: 100));
