...
class InquiryCNBCNewsTech extends StatefulWidget {
  ...
  @override
  State<InquiryCNBCNewsTech> createState() => _InquiryCNBCNewsTechState();
}

class _InquiryCNBCNewsTechState extends State<InquiryCNBCNewsTech> {
  ...
  void processData(BeritaModel data) async {
    ...
    CNBCNewsRepository.instance.setNullListJudulTeknologiCNBCNews();
    await Future.delayed(const Duration(milliseconds: 100));
