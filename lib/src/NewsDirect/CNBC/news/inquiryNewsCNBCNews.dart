...
class InquiryCNBCNewsNews extends StatefulWidget {
  ...
  @override
  State<InquiryCNBCNewsNews> createState() => _InquiryCNBCNewsNewsState();
}

class _InquiryCNBCNewsNewsState extends State<InquiryCNBCNewsNews> {
  ...
  void processData(BeritaModel data) async {
    ...
    CNBCNewsRepository.instance.setNullListJudulNewsCNBCNews();
    await Future.delayed(const Duration(milliseconds: 100));
