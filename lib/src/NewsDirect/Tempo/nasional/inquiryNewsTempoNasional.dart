...
class InquiryTempoNewsNasional extends StatefulWidget {
  const InquiryTempoNewsNasional({Key? key}) : super(key: key);

  @override
  State<InquiryTempoNewsNasional> createState() => _InquiryTempoNewsNasionalState();
}

class _InquiryTempoNewsNasionalState extends State<InquiryTempoNewsNasional> {
  ...
  Future<BeritaModel?> getData() async {
    try {
      String url = 'https://api-berita-indonesia.vercel.app/tempo/nasional';
  ...
  void processData(BeritaModel data) async {
    ...
    TempoNewsRepository.instance.setNullListJudulNasionalTempoNews();
    await Future.delayed(const Duration(milliseconds: 100));
    int tempCtr = TempoNewsRepository.instance.getCountPeriod();
    await TempoNewsRepository.instance.getAllNewsTempoNasional(tempCtr);
    await TempoNewsRepository.instance.getAllNewsTempoNasional(tempCtr-1);
    await TempoNewsRepository.instance.getAllNewsTempoNasional(tempCtr-2);
    await TempoNewsRepository.instance.getAllNewsTempoNasional(tempCtr-3);
    List<String> listJudul = TempoNewsRepository.instance.getListJudulNasionalTempoNews();
