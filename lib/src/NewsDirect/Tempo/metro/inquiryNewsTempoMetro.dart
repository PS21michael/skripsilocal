...
class InquiryTempoNewsMetro extends StatefulWidget {
  const InquiryTempoNewsMetro({Key? key}) : super(key: key);

  @override
  State<InquiryTempoNewsMetro> createState() => _InquiryTempoNewsMetroState();
}

class _InquiryTempoNewsMetroState extends State<InquiryTempoNewsMetro> {
  ...
  Future<BeritaModel?> getData() async {
    try {
      String url = 'https://api-berita-indonesia.vercel.app/tempo/metro';
  ...
  void processData(BeritaModel data) async {
    ...
    TempoNewsRepository.instance.setNullListJudulMetroTempoNews();
    await Future.delayed(const Duration(milliseconds: 100));
    int tempCtr = TempoNewsRepository.instance.getCountPeriod();
    await TempoNewsRepository.instance.getAllNewsTempoMetro(tempCtr);
    await TempoNewsRepository.instance.getAllNewsTempoMetro(tempCtr-1);
    await TempoNewsRepository.instance.getAllNewsTempoMetro(tempCtr-2);
    await TempoNewsRepository.instance.getAllNewsTempoMetro(tempCtr-3);
    List<String> listJudul = TempoNewsRepository.instance.getListJudulMetroTempoNews();
