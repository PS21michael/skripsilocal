...
import 'package:skripsilocal/pages/components/InquiryHeader.dart';import 'package:skripsilocal/src/NewsDirect/Tempo/core/tempo_news_repository.dart';
import '../../../../models/berita_model.dart';

class InquiryTempoNewsCantik extends StatefulWidget {
  const InquiryTempoNewsCantik({Key? key}) : super(key: key);

  @override
  State<InquiryTempoNewsCantik> createState() => _InquiryTempoNewsCantikState();
}

class _InquiryTempoNewsCantikState extends State<InquiryTempoNewsCantik> {
  final newsRepo = Get.put(TempoNewsRepository());
  final String author = "Tempo Cantik - Berita Terkini dan Tips Seputar Dunia Wanita";
  final String publisher = "Tempo News";
  final String category = "Cantik";
  ...
  Future<BeritaModel?> _getData() async {
    try {
      String url = 'https://api-berita-indonesia.vercel.app/tempo/cantik';
