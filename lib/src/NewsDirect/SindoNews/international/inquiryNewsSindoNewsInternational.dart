...
class InquirySindoNewsInternational extends StatefulWidget {
  ...
  @override
  State<InquirySindoNewsInternational> createState() => _InquirySindoNewsInternationalState();
}

class _InquirySindoNewsInternationalState extends State<InquirySindoNewsInternational> {
  ...
  final String publisher = "SINDO News";
  ...
  void processData(BeritaModel data) async {
    ...
    SindoNewsRepository.instance.setNullListJudulInternasionalSindoNews();
    await Future.delayed(const Duration(milliseconds: 100));
