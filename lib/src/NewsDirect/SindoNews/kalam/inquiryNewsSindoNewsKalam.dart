...
class InquirySindoNewsKalam extends StatefulWidget {
  ...
  @override
  State<InquirySindoNewsKalam> createState() => _InquirySindoNewsKalamState();
}

class _InquirySindoNewsKalamState extends State<InquirySindoNewsKalam> {
  ...
  void processData(BeritaModel data) async {
    ...
    SindoNewsRepository.instance.setNullListJudulKalamSindoNews();
    await Future.delayed(const Duration(milliseconds: 100));
