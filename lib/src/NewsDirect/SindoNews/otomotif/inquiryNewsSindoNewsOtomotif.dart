...
class InquirySindoNewsOtomotif extends StatefulWidget {
  const InquirySindoNewsOtomotif({Key? key}) : super(key: key);

  @override
  State<InquirySindoNewsOtomotif> createState() => _InquirySindoNewsOtomotifState();
}

class _InquirySindoNewsOtomotifState extends State<InquirySindoNewsOtomotif> {
  ...
  Future<BeritaModel?> getData() async {
    try {
      String url = 'https://api-berita-indonesia.vercel.app/sindonews/otomotif';
  ...
  void processData(BeritaModel data) async {
    ...
    SindoNewsRepository.instance.setNullListJudulOtomotifSindoNews();
    await Future.delayed(const Duration(milliseconds: 100));
    int tempCtr = SindoNewsRepository.instance.getCountPeriod();
    await SindoNewsRepository.instance.getAllNewsSindoNewsOtomotif(tempCtr);
    await SindoNewsRepository.instance.getAllNewsSindoNewsOtomotif(tempCtr-1);
    await SindoNewsRepository.instance.getAllNewsSindoNewsOtomotif(tempCtr-2);
    await SindoNewsRepository.instance.getAllNewsSindoNewsOtomotif(tempCtr-3);
    List<String> listJudul = SindoNewsRepository.instance.getListJudulOtomotifSindoNews();
