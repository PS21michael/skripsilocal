...
class InquirySindoNewsLifeStyle extends StatefulWidget {
  ...
  @override
  State<InquirySindoNewsLifeStyle> createState() => _InquirySindoNewsLifeStyleState();
}

class _InquirySindoNewsLifeStyleState extends State<InquirySindoNewsLifeStyle> {
  ...
  void processData(BeritaModel data) async {
    ...
    SindoNewsRepository.instance.setNullListJudulLifeStyleSindoNews();
    await Future.delayed(const Duration(milliseconds: 100));
