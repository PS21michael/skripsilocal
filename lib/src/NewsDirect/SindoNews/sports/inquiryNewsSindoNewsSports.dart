...
class InquirySindoNewsSports extends StatefulWidget {
  ...
  @override
  State<InquirySindoNewsSports> createState() => _InquirySindoNewsSportsState();
}

class _InquirySindoNewsSportsState extends State<InquirySindoNewsSports> {
  ...
  void processData(BeritaModel data) async {
    ...
    SindoNewsRepository.instance.setNullListJudulSportsSindoNews();
    await Future.delayed(const Duration(milliseconds: 100));
