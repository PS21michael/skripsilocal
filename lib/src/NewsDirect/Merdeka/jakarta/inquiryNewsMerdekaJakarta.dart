...
class InquiryMerdekaNewsJakarta extends StatefulWidget {
  ...
  @override
  State<InquiryMerdekaNewsJakarta> createState() => _InquiryMerdekaNewsJakartaState();
}

class _InquiryMerdekaNewsJakartaState extends State<InquiryMerdekaNewsJakarta> {
  ...
  void processData(BeritaModel data) async {
    ...
    MerdekaNewsRepository.instance.setNullListJudulJakartaMerdekaNews();
    await Future.delayed(const Duration(milliseconds: 100));
