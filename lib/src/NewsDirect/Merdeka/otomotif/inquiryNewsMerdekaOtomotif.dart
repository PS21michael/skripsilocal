...
class InquiryMerdekaNewsOtomotif extends StatefulWidget {
  ...
  @override
  State<InquiryMerdekaNewsOtomotif> createState() => _InquiryMerdekaNewsOtomotifState();
}

class _InquiryMerdekaNewsOtomotifState extends State<InquiryMerdekaNewsOtomotif> {
