...
class InquiryMerdekaNewsGaya extends StatefulWidget {
  ...
  @override
  State<InquiryMerdekaNewsGaya> createState() => _InquiryMerdekaNewsGayaState();
}

class _InquiryMerdekaNewsGayaState extends State<InquiryMerdekaNewsGaya> {
  ...
  void processData(BeritaModel data) async {
    ...
    MerdekaNewsRepository.instance.setNullListJudulGayaMerdekaNews();
    await Future.delayed(const Duration(milliseconds: 100));
