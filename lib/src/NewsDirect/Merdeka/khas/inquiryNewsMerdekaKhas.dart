...
class InquiryMerdekaNewsKhas extends StatefulWidget {
  const InquiryMerdekaNewsKhas({Key? key}) : super(key: key);

  @override
  State<InquiryMerdekaNewsKhas> createState() => _InquiryMerdekaNewsKhasState();
}

class _InquiryMerdekaNewsKhasState extends State<InquiryMerdekaNewsKhas> {
  final newsRepo = Get.put(MerdekaNewsRepository());
  final String author = "Merdeka News | Khas Indonesia";
  final String publisher = "Merdeka News";
  final String category = "Khas";
