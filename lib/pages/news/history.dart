...
class _HistoryPageState extends State<HistoryPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: DetailHeader(),
        body: HistoryRepository.instance.isDataExist == "YES" ? buildHistory(idPengguna) : buildNoData(),
      ),
    );
  }
                ...
                child: SingleChildScrollView(
                  child: Container(
                    ...
                    child: FutureBuilder<List<HistoryModel>>(
                      future: controller.getAllHistoryFromSingleUserOrderByTime(idPengguna, "DESC"),
