...
class FilterExploreCategoryPage extends StatefulWidget {
  final String inputFilter;
  const FilterExploreCategoryPage({
    Key? key,
    required this.inputFilter,
  }) : super(key: key);

  @override
  State<FilterExploreCategoryPage> createState() => _FilterExploreCategoryPageState();
}

class _FilterExploreCategoryPageState extends State<FilterExploreCategoryPage> {
